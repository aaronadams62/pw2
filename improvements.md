...
| ~~5~~ | ~~**Uptime Monitoring**~~ | ✅ **Fixed #54** — Added GitHub Actions scheduled uptime checks (`.github/workflows/uptime-check.yml`) running every 12 hours for `/` and `/admin`. Supports manual dispatch and optional `UPTIME_CHECK_BASE_URL` repo variable override. |
